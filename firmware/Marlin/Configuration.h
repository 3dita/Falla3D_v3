...
#define CUSTOM_MACHINE_NAME "Falla V3"
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {80,80,2560,90.1}  // default steps per unit for Ultimaker
#define DEFAULT_MAX_FEEDRATE          {300, 300, 6, 100}    // (mm/sec)
...
#define DEFAULT_ZJERK                 1.6     // (mm/sec)
